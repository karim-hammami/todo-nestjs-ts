...
export class AppController {
  constructor(private readonly appService: AppService, private readonly todoService: TodoService) {}
  ...
  @Post('todos')
  async createTodo(@Body() todoData: {title: string, desc: string}): Promise<TodoModel> {
  ...
  @Put('todos/:id')
  async updateTodoById(@Param('id') id: string, @Body() todoData: {title: string, desc: string, status: string}): Promise<TodoModel> {
